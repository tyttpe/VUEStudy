			...
			children: [{
				...
				},
				{
					...
					children: [{
							//题库
							path: '/title_lib',
							component: resolve => require(['../components/TitleLib.vue'], resolve),
							meta: {
								title: '题库'
							}
						},
						{
							//资源库
							path: '/resourse_lib',
							component: resolve => require(['../components/ResourseLib.vue'], resolve),
							meta: {
								title: '资源库'
							}
						},
						{
							//活动库
							path: '/action_lib',
							component: resolve => require(['../components/ActionLib.vue'], resolve),
							meta: {
								title: '活动库'
							}
						}
